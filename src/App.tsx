import { Music, Laptop, Download, Users, CheckCircle, Star, Globe, Phone, MapPin, Headphones, Play, Volume2 } from 'lucide-react';
...
function VSTCard({ image, title, description, price, format, size }: VSTCardProps) {
  return (
...
function TestimonialCard({ name, role, content, image }: TestimonialCardProps) {
  return (
...
function PricingCard({ title, price, features, buttonText, popular }: PricingCardProps) {
  return (
      ...
      <section id="plugins" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            ...
            />
            <VSTCard 
              image="https://images.unsplash.com/photo-1664120942596-d472815ef713?auto=format&fit=crop&w=800"
